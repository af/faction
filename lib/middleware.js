        ...
        return function(next) {
            return function handleMiddlewareAction(action) {
                ...
                if (action.meta._executeInMiddleware) {
                    delete action.meta._executeInMiddleware     // Prevent action from being re-dispatched
                    var inputs = action.meta._deferredInputs
                    action.payload = action.meta._deferredHandler(inputs, store)
                }
